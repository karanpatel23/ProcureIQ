...
export function ProductFilm() {
  ...
  return (
    <section className="product-film" aria-label="Procurement intelligence preview">
      ...
      <div className="film-core"><span>Decision layer</span><strong>Supplier context forms in real time</strong><p>Signals, exceptions, approval state, and next action stay visible.</p></div>
  ...
  return (
    <section className="hero section-shell">
      <div className="hero-copy">
        ...
        <p className="hero-subhead">ProcureIQ brings supplier context, guided review, and approval visibility into one intelligent workspace for modern purchasing teams.</p>
