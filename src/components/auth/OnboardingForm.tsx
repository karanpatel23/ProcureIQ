...
export function OnboardingForm() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!result.ok) { setError(result.error?.message ?? 'Could not create workspace.'); setLoading(false); return; }
