...
export function SupplierForm({ supplier }: { supplier?: Supplier }) {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = Object.fromEntries(['name','contactPerson','email','phone','website','category','typicalItems','paymentTerms','notes','status'].map((key) => [key, String(form.get(key) ?? '')]));
