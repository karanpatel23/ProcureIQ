...
export const alt = 'ProcureIQ — The AI decision layer for procurement';
    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 80, background: 'linear-gradient(150deg, #0e1116 0%, #171c25 60%, #10131a 100%)', color: '#e9e6e7', fontFamily: 'sans-serif' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <div style={{ fontSize: 40, fontWeight: 700, letterSpacing: -1 }}>ProcureIQ</div>
        </div>
        ...
        <div style={{ fontSize: 26, color: '#6b7c98', fontWeight: 600 }}>procureiqs.com</div>
      </div>
    ),
    { ...size },
  );
